...
// Mock user location (San Francisco downtown area)
export const DEFAULT_USER_LOCATION: GeoJSONPoint = {
  type: 'Point' as const,
  coordinates: [-122.4194, 37.7749], // [lng, lat] - GeoJSON standard
};
...
export const mockUsers: User[] = [
  {
    ...
    location: { type: 'Point' as const, coordinates: [-122.4180, 37.7760] },
    address: '123 Main St',
    trustScore: 4.8,
    totalReviews: 23,
    itemsLentCount: 45,
  ...
  },
  {
    ...
    location: { type: 'Point' as const, coordinates: [-122.4210, 37.7735] },
    address: '456 Oak Ave',
    trustScore: 4.5,
    totalReviews: 18,
    itemsLentCount: 32,
  ...
  },
  {
    ...
    location: { type: 'Point' as const, coordinates: [-122.4165, 37.7780] },
    address: '789 Pine St',
    trustScore: 4.2,
    totalReviews: 9,
    itemsLentCount: 15,
  ...
  },
  {
    ...
    location: { type: 'Point' as const, coordinates: [-122.4230, 37.7755] },
    address: '321 Elm St',
    trustScore: 3.8,
    totalReviews: 5,
    itemsLentCount: 8,
